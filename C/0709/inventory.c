/*Maintains a parts detabase (linked list version)*/
#include <stdio.h>
#include "readline.h"
...
struct part
*inventory = NULL;/*point to first part*/
...
/************************************************************
 *main:Prompt the user to enter an operation code,          *
 ...
 *        then inserts the part into the inventory list;          *
          the list remains sorted by part number. Prints an error *
 *        message and returns prematurely if the part already     *
 ...
 *        message if the part does't exist; otherwise, prompts the *
 *        user to enter change in quantity on hand and update the  *
 *        database                                                 *
 *******************************************************************/
void
update(void)
 ...
 *       the part number, part name, and quantity on hand. Parts   *
 *       are printed in the order in which they were entered into  *
 *       database.                                                 *
********************************************************************/
void
print(void)
